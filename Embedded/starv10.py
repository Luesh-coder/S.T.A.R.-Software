"""
S.T.A.R. – Raspberry Pi CM5 Vision & Tracking  (v10)

Changes vs. v9:
  - Switched inference backend from NCNN to OpenVINO (yolo11n_openvino_model)
  - Raised detection confidence threshold from 0.5 to 0.8
  - Pan range on ESP32 side widened to 30-150 (see STAR_ESP32_APP_AND_TRACKING_V2)
"""
